...
% GM_bouncing_Apr18.mat and AGE.mat should be in the same folder.

load GM_bouncing_Apr18 E
M = E;
...
%     Mselected = M{subj}(G{subj}==tree & M{subj}~=0 & abs(M{subj})<0.15);

    if length(Mselected)>=3,
        Bmat(subj) = median(abs(Mselected),'omitnan');
...
hold on
% plot(age(intersect(NTg,Valid)),Bmat(intersect(NTg,Valid)),'^','color',[1 1 1]*0.7,'linewidth',2,'markersize',12,'markerfacecolor',[1 1 1]*0.7,'markeredgecolor','none')
% plot(age([adultSetg]),Bmat([adultSetg]),'^','color',[1 1 1]*0.7,'linewidth',2,'markersize',12,'markerfacecolor',[1 1 1]*0.7,'markeredgecolor','none')

% plot(age(intersect(NTb,Valid)),Bmat(intersect(NTb,Valid)),'o','color',[1 1 1]*0.7,'linewidth',2,'markersize',12,'markerfacecolor',[1 1 1]*0.7,'markeredgecolor','none')
% plot(age([adultSetb]),Bmat([adultSetb]),'o','color',[1 1 1]*0.7,'linewidth',2,'markersize',12,'markerfacecolor',[1 1 1]*0.7,'markeredgecolor','none')
