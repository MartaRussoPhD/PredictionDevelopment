...
% GM_mc_RT_MT.mat and AGE.mat should be in the same folder.

load GM_mc_RT_MT.mat R
M = R;
...
% NTb = [222 226 231 235 251 253 232 116 263 258 266 265];
...
[Fexp GoFexp] = fit(Age(Valid)',Bmat(Valid)',fcnexp,'start',[500 0.5 100]);
